...
--changeset yura:11
alter table person add column car_id int,
...
--changeset yura:14
alter table result_table drop column car_id;
...
--changeset yura:18 endDelimiter:#
...
--changeset yura:19
GRANT EXECUTE ON FUNCTION stage_violation_load() to yura;

--changeset yura:20
select stage_violation_load();

--changeset yura:21
drop function stage_violation_load();

--changeset yura:22 endDelimiter:#
...
--changeset yura:23 endDelimiter:#
...
language plpgsql
 AS
    ...
    select make, model from public.violation;
    end;
    $$;
--#

--changeset yura:24
drop function stage_auto_load();

--changeset yura:25 endDelimiter:#
TRUNCATE TABLE stage.auto;
...
--changeset yura:28 endDelimiter:#
...
--changeset yura:30 endDelimiter:#
...
drop function stage_person_load();
...
--changeset yura:32 endDelimiter:#
TRUNCATE TABLE stage.person;
...
--changeset yura:34 endDelimiter:#
